  ...
  const { data: rows = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      const mappedV = vids.map((v: any) => ({
        ...
        name_en: v.client_name_en ?? "",
        role_ar: v.client_specialty || "",
        role_en: v.client_specialty_en || "",
        title_ar: v.client_title || "",
        title_en: v.client_title_en || "",
        media_type: "video",
      ...
      const mappedW = writ.map((w: any) => ({
        ...
        name_en: w.client_name_en ?? "",
        role_ar: w.client_specialty || "",
        role_en: w.client_specialty_en || "",
        title_ar: w.client_title || "",
        title_en: w.client_title_en || "",
        excerpt_ar: w.review_text || "",
        excerpt_en: w.review_text_en || "",
        full_text_ar: w.review_text || "",
        full_text_en: w.review_text_en || "",
        media_type: "image",
  ...
  async function saveItem(i: number) {
    ...
    const payload: any = isVideo
      ? {
          ...
          client_name_en: it.name_en?.trim() || null,
          client_title: it.title_ar || null,
          client_title_en: it.title_en?.trim() || null,
          client_specialty: it.role_ar || null,
          client_specialty_en: it.role_en?.trim() || null,
      ...
      : {
          ...
          review_text_en: it.full_text_en?.trim() || it.excerpt_en?.trim() || null,
